...
const CARDS = [
  { term:"Spatial / Sincere Voting", cat:"Voting & Participation", def:"Voting for the candidate closest to your own policy preferences, with no strategic calculation.", hint:"Pure preference expression — no gaming the system." },
  { term:"Median Voter Theorem", cat:"Voting & Participation", def:"In a two-candidate race with single-peaked preferences, the winning candidate is closest to the median voter's position.", hint:"Both parties converge to the center — explains why platforms often look alike." },
  { term:"Strategic Voting", cat:"Voting & Participation", def:"Voting for a less-preferred candidate to prevent a worse outcome (e.g., voting for your 2nd choice to block your last choice).", hint:"Common in FPTP systems — voting for the 'lesser evil'." },
  ...
  { term:"Voice (Hirschman)", cat:"Voting & Participation", def:"Using speech, protest, or political action to change an organization from within.", hint:"Voice is chosen when exit is too costly or loyalty is high." },
  { term:"Loyalty (Hirschman)", cat:"Voting & Participation", def:"Remaining in a relationship despite dissatisfaction, hoping things improve.", hint:"Loyalty suppresses both exit and voice." },
  { term:"Collective Action Problem", cat:"Voting & Participation", def:"Individually rational behavior (free-riding) leads to a collectively suboptimal outcome — e.g., no one votes because each vote seems not to matter.", hint:"Core reason voter turnout is 'puzzling' from a rational-choice view." },
  ...
  { term:"Ethnicity (Chandra)", cat:"Ethnicity & Identity", def:"A subset of identity categories where membership is determined by descent-based attributes: ancestry, race, language, religion, tribe, caste, etc.", hint:"Key: descent-based, not freely chosen. Distinct from other social identities." },
  { term:"Ethnic Fractionalization", cat:"Ethnicity & Identity", def:"The probability that two randomly selected individuals belong to different ethnic groups. Higher = more diverse.", hint:"Does NOT capture inequality between groups — distinct from polarization." },
  { term:"Primordialism", cat:"Ethnicity & Identity", def:"View that ethnic identities are ancient, fixed, and emotionally deep-rooted — almost biological.", hint:"Criticized: ignores how identities shift historically." },
  ...
  { term:"Party Identification / Partisanship", cat:"Parties & Systems", def:"A psychological attachment or sense of belonging to a political party, often stable over time.", hint:"Distinct from 'which party you vote for' — it's identity." },
  { term:"Running Tally (Fiorina)", cat:"Parties & Systems", def:"Partisanship = a running average of past performance evaluations of each party. Retrospective and updateable.", hint:"Partisanship is rational — you update based on what parties actually do." },
  { term:"Social Identity (Partisanship)", cat:"Parties & Systems", def:"Green, Palmquist & Schickler view: partisanship is a social identity ('I am a Democrat') — stable, resistant to policy shifts, like team loyalty.", hint:"Explains why people don't switch parties even when their party underperforms." },
  ...
  { term:"One-Party System", cat:"Parties & Systems", def:"Only one party is legally allowed to exist or compete; opposition is banned.", hint:"E.g., China (CCP), Soviet-era USSR." },
  { term:"Single-Party Dominant System", cat:"Parties & Systems", def:"Multiple parties exist and compete but one wins elections consistently over long periods.", hint:"E.g., Japan (LDP), South Africa (ANC), Sweden (Social Democrats historically)." },
  { term:"Two-Party System", cat:"Parties & Systems", def:"Two major parties dominate; third parties rarely win. Product of FPTP electoral rules + Duverger's Law.", hint:"E.g., USA, UK historically." },
  { term:"Multi-Party System", cat:"Parties & Systems", def:"Three or more parties regularly win seats and can govern. Common under proportional representation.", hint:"E.g., Germany, Netherlands, Israel." },
  { term:"Effective Number of Parties", cat:"Parties & Systems", def:"A weighted measure of how many parties really matter (by seat/vote share), not just how many exist.", hint:"Formula: 1 / Σ(seat share²). 10 tiny parties ≠ 10-party system." },
  ...
  { term:"Duverger's Law", cat:"Parties & Systems", def:"FPTP systems tend to produce two-party systems; proportional representation tends to produce multi-party systems.", hint:"Mechanism: strategic voting + party entry decisions under FPTP squeeze out third parties." },
